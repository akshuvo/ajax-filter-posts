            ...
            <div class="form-row d-flex" id="<?php esc_attr_e( $field_name ); ?>_field" data-priority="">
                ...
                <div class="gridmaster-input-wrapper">
                    ...
                    <?php foreach( $taxonomy_options as $tax_name => $tax_label ): ?>
                        <div> <label class="radio gm-field-label"><input type="checkbox" class="input-radio " value="<?php esc_attr_e( $tax_name ); ?>" name="<?php esc_attr_e( $field_name ); ?>" id="<?php esc_attr_e( $field_name . $tax_name ); ?>"> <?php esc_attr_e( $tax_label ); ?></label></div>
                    <?php endforeach; ?>
